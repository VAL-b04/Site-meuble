...
ALTER TABLE adresse
ADD CONSTRAINT fk_adresse_utilisateur FOREIGN KEY (utilisateur_id) REFERENCES utilisateur(id_utilisateur) ON DELETE CASCADE;
...
INSERT INTO adresse (adresse, code_postal, ville, pays, utilisateur_id) VALUES
('123 Rue Principale', '75001', 'Paris', 'France', 1),
('456 Avenue des Champs', '75008', 'Paris', 'France', 2),
('789 Boulevard Saint-Michel', '75005', 'Paris', 'France', 3);
...
('Canape_Plast', 'Canape en plastique super comfortable', 289.67, 'rose', 3, 'PLASTOC', 'Le_plastique_c_est_genial', 'canape_en plastique.png', 3, 2),
